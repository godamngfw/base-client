...
namespace openvpn {
  ...
  inline Frame::Ptr frame_init()
  {
    ...
    (*frame)[Frame::READ_TRANSPORT_SSL_CIPHERTEXT] = Frame::Context(headroom, payload, tailroom, 3, align_block, buffer_flags);
    (*frame)[Frame::READ_OPENVPN_BIO_MEMQ_STREAM] = Frame::Context(headroom, control_channel_payload, tailroom, 0, align_block, buffer_flags);
    (*frame)[Frame::READ_TRANSPORT_BIO_MEMQ_STREAM] = Frame::Context(headroom, control_channel_payload, tailroom, 0, align_block, buffer_flags);
